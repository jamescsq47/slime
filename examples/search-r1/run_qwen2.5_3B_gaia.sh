...
CKPT_ARGS=(
   --hf-checkpoint /workspace/Qwen3-32B/
   --ref-load /workspace/Qwen3-32B_torch_dist/ # Qwen3-4B_torch_dist/
...
WANDB_ARGS=(
   ...
   --wandb-group search-r1_qwen3-32B-eval
   --wandb-key ${WANDB_KEY}
)

...
def main() -> None:
    ...
    summary = {
        ...
        "prefill_gpu_active_tps": p_compute / p_gpu,
        "decode_gpu_active_tps": d_decode / d_gpu,
        ...
        "ideal_decode_gpus_per_prefill_gpu_from_gpu_time": (d_gpu / completed_count) / (p_gpu / completed_count),

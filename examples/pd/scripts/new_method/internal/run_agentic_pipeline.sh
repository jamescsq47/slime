...
export SGLANG_AGENTIC_KV_REGISTER_STARTUP_BARRIER="${SGLANG_AGENTIC_KV_REGISTER_STARTUP_BARRIER:-${SGLANG_AGENTIC_KV_REGISTER_EAGER_ARENA}}"
export SGLANG_AGENTIC_KV_REGISTER_PREWARM_DIR="${SGLANG_AGENTIC_KV_REGISTER_PREWARM_DIR:-${PD_P_READY_DIR}/host-register-prewarm}"
export SGLANG_AGENTIC_KV_REGISTER_PREWARM_TIMEOUT_SECONDS="${SGLANG_AGENTIC_KV_REGISTER_PREWARM_TIMEOUT_SECONDS:-1800}"
...
export SGLANG_AGENTIC_KV_FAST_DIRECT_FAILURE_RECOMPUTE="${SGLANG_AGENTIC_KV_FAST_DIRECT_FAILURE_RECOMPUTE:-false}"

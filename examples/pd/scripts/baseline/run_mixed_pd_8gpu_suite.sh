...
run_case pd-no-reverse-2p6d \
  ...
  PREFILL_MEM_FRACTION_STATICS='0.80 0.80' \
  DECODE_GPUS='2 3 4 5 6 7' \
  DECODE_PORTS='33102 33103 33104 33105 33106 33107' \
  DECODE_MEM_FRACTION_STATICS='0.80 0.80 0.80 0.80 0.80 0.60' \
...
run_case pd-no-reverse-4p4d \
  ...
  PREFILL_MEM_FRACTION_STATICS='0.80 0.80 0.80 0.80' \
  DECODE_GPUS='4 5 6 7' DECODE_PORTS='33304 33305 33306 33307' \
  DECODE_MEM_FRACTION_STATICS='0.80 0.80 0.80 0.60' \

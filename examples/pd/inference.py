...
async def async_main(cli: argparse.Namespace) -> None:
    ...
    runtime_keys = (
        ...
        "SGLANG_AGENTIC_KV_REGISTERED_EXTENT_DMA",
        "SGLANG_AGENTIC_KV_REGISTER_WINDOW_GIB",
        "SGLANG_AGENTIC_KV_REGISTER_CACHE_GIB",
        "SGLANG_AGENTIC_KV_REGISTER_EAGER_ARENA",
        "SGLANG_AGENTIC_KV_REGISTER_STARTUP_BARRIER",
        "SGLANG_AGENTIC_KV_REGISTER_PREWARM_TIMEOUT_SECONDS",

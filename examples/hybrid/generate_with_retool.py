...
def append_observation_with_budget(
    ...
    if remaining_budget <= 0:
        return response, response_token_ids, loss_masks, rollout_log_probs, True
    ...
    return response, response_token_ids, loss_masks, rollout_log_probs, truncated

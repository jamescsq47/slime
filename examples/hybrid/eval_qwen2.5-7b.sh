...
CKPT_ARGS=(
   --hf-checkpoint /workspace/Qwen2.5-32B-Instruct
   --ref-load /workspace/Qwen2.5-32B-Instruct_torch_dist
...
WANDB_ARGS=(
   --use-wandb
   --wandb-project Qwen2.5-32B-eval
   --wandb-group Qwen2.5-32B-Instruct
...
ROLLOUT_ARGS=(
   ...
   --save-debug-rollout-data /workspace/slime/examples/hybrid/debug/eval/Qwen2.5-32B-Instruct.pt
   --debug-rollout-only
)
...
EVAL_ARGS=(
   ...
   # --eval-prompt-data gsm8k /workspace/data/gsm8k/test.parquet \
                     #  nq_test /workspace/Search-R1/data/nq_hotpotqa_train/test.parquet@[0:3000] \
                     #  browsecomp /workspace/data/browsecomp/test.parquet \
   ...
   --eval-dataset-override aime25.n_samples_per_eval_prompt=1
   --eval-dataset-override aime25.max_response_len=31800
   ...
   --eval-dataset-override aime2024.n_samples_per_eval_prompt=1
   --eval-dataset-override aime2024.max_response_len=31800

...
CKPT_ARGS=(
   ...
   --ref-load /workspace/Qwen3-8B-block16-mask51200-51200/iter399_torch_dist
   # --load /root/Qwen3-4B_slime/
#    --save /workspace/Qwen3-4B_sync_hybrid0.5/
#    --save-interval 100s
)
# Qwen3-8B-mixed0.5-mask5120-256
# Qwen3-8B_hybrid_mask256_512/iter799_torch_dist
# Qwen3-8B_hybrid_mask0_5120/iter799_torch_dist
# Qwen3-8B_hybrid_mask0_512/iter799_torch_dist
...
ROLLOUT_ARGS=(
   ...
   # --save-debug-rollout-data /workspace/slime/examples/hybrid/debug/eval/Qwen3-8B_mixed0.5-mask5120-256-iter399.pt
)
...
EVAL_ARGS=(
   ...
   --eval-dataset-override aime25.n_samples_per_eval_prompt=16
   ...
   --eval-dataset-override aime2024.n_samples_per_eval_prompt=16
